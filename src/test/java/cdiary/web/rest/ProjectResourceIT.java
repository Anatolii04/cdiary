...
import cdiary.domain.Project;
import cdiary.repository.ProjectRepository;
...
public class ProjectResourceIT {
    ...
    private static final Status DEFAULT_STATUS = Status.REDPOINT;
    private static final Status UPDATED_STATUS = Status.FLASH;
