...
import cdiary.CdiaryApp;
import cdiary.domain.Session;
import cdiary.repository.SessionRepository;
import cdiary.web.rest.errors.ExceptionTranslator;
...
import static cdiary.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = CdiaryApp.class)
public class SessionResourceIT {

    private static final String DEFAULT_THOUGHTS = "AAAAAAAAAA";
    private static final String UPDATED_THOUGHTS = "BBBBBBBBBB";
    ...
    public void createSession() throws Exception {
        ...
        assertThat(testSession.getThoughts()).isEqualTo(DEFAULT_THOUGHTS);
    ...
    public void getAllSessions() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].thoughts").value(hasItem(DEFAULT_THOUGHTS.toString())))
    ...
    public void getAllSessionsWithEagerRelationshipsIsEnabled() throws Exception {
        ...
        MockMvc restSessionMockMvc = MockMvcBuilders.standaloneSetup(sessionResource)
            .setCustomArgumentResolvers(pageableArgumentResolver)
            .setControllerAdvice(exceptionTranslator)
            .setConversionService(createFormattingConversionService())
    ...
    public void getSession() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions/{id}", session.getId()))
            ...
            .andExpect(jsonPath("$.thoughts").value(DEFAULT_THOUGHTS.toString()))
    ...
    public void updateSession() throws Exception {
        ...
        Session testSession = sessionList.get(sessionList.size() - 1);
        assertThat(testSession.getThoughts()).isEqualTo(UPDATED_THOUGHTS);
